...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DrawerContentViewController * drawer = [[DrawerContentViewController alloc] init];
    ZXDrawerViewController * vc = [[ZXDrawerViewController alloc] init];
    [vc setMainViewController:navi];
    [vc setDrawerViewController:drawer];
    //设置宽度必须在drawerviewcontroller指派以后
    [vc setDrawerWidth:180];
